        ...
        <div class="hidden md:block w-full max-w-4xl">
            <div class="bg-black bg-opacity-70 rounded-xl shadow-2xl overflow-hidden">
                <div class="grid grid-cols-2">
                    <!-- Left Side - Branding -->
                    <div class="bg-gradient-to-br from-blue-700 to-indigo-400 p-10 flex flex-col justify-between">
                        <div>
                    ...
                    <form @submit.prevent="submitForm">
                        <div class="mb-4">
                            ...
                            <input 
                                ...
                                class="w-full px-4 py-3 bg-gray-200 border border-gray-400 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-indigo-600"
                                required
                            >
                        </div>
